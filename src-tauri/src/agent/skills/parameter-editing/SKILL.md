...
3. Use `preview_parameter_batch` before the legacy parameter batch executor. For official parameter, group, and key mutations, use the matching `preview_*` tool.
